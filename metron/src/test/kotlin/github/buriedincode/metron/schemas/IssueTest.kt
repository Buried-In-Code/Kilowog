    ...
    inner class GetIssue {
        ...
        fun `Test GetIssue with a valid id`() {
            ...
            assertAll(
                ...
                { assertTrue(result.isbn?.isEmpty() ?: false) },
